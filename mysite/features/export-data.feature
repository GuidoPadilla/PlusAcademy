Feature: Exportación de datos de pago 
        ...
        Scenario: Se desea agregar la foto de la confirmación de la boleta
                Given: La sección de control de pagos
                When: Se quiere agregar un archivo escaneado con la confirmacion
                Then: Se permite seleccionar y subir un archivo 
